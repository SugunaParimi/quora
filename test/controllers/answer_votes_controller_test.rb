...
class AnswerVotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer_vote" do
    assert_difference("AnswerVote.count") do
      post answer_votes_url, params: { answer_vote: { answer_id: @answer_vote.answer_id, vote_type: @answer_vote.vote_type } }
    end
  ...
  test "should update answer_vote" do
    patch answer_vote_url(@answer_vote), params: { answer_vote: { answer_id: @answer_vote.answer_id_id, vote_type: @answer_vote.vote_type } }
