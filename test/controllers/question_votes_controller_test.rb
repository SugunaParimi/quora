...
class QuestionVotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_vote" do
    assert_difference("QuestionVote.count") do
      post question_votes_url, params: { question_vote: { question_id_id: @question_vote.question_id, vote_type: @question_vote.vote_type } }
    end
  ...
  test "should update question_vote" do
    patch question_vote_url(@question_vote), params: { question_vote: { question_id_id: @question_vote.question_id_id, vote_type: @question_vote.vote_type } }
